    ...
    public class Maze
    {
                ...
                for (int j = 0; j < ma.GetLength(1); j++)
                {
                    switch (ma[i, j])
                    {
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            Walls.Add(new Wall(game, wallHorizontal, new Vector2(i * 32 + 16, j * 32 + 16),Color.Green));
                            break;
                        case 8:
                            break;
                        case 9:
        ...
        private int[,] MazeArray()
        {
            ...
            int[,] result = {
                ...
                {0,0,0,b,5,5,5,c,16,6,b,5,5,c,0,7,0,0,0,6,0,6,b,5,5,c,16,6,b,5,5,c,16,6,0,0},
                {0,0,0,a,5,5,5,d,16,6,a,5,5,d,0,7,0,0,0,6,0,6,a,5,5,d,16,6,a,5,5,d,16,6,0,0},
                {0,0,0,6,16,16,16,16,16,6,6,16,0,0,0,6,0,0,0,6,0,6,6,16,16,16,16,6,6,16,16,16,16,6,0,0},
